...
const DriverRegisterScreenIdBack = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonInputContainer}>
            ...
            style={styles.button}
            >
                <Text style={styles.buttonText} >Take A Photo Of Your ID Back</Text>
            </TouchableOpacity>
        </View>
      {/* <Button style={styles.button} title="Pick Image" onPress={pickImage} /> */}
      {/* <Button title="Take a photo" onPress={() => pickImage(true)} /> */}
      {image && <Image source={{ uri: image }} style={{ width: 200, height: 200, top:0 }} />}
    </View>
  );
};

export default DriverRegisterScreenIdBack;
